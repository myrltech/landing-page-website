...
import AquaplanLandingPageMain from "../components/desktop/case-studies-new/aquaplan/AquaplanLandingPageMain";
...
export default function aquaplan() {
  return (
    <>
      <HeadTag
        title=" Myrl Tech"

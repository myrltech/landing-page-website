...
import FintifyLandingPageMain from "../components/desktop/case-studies-new/fintify/FintifyLandingPageMain";
import HeadTag from "../components/desktop/common/HeadTag";
// import Fintify from "../components/desktop/fintify/Fintify";
...
export default function fintify() {
  return (
    <>
      <HeadTag
        title=" Myrl Tech"
